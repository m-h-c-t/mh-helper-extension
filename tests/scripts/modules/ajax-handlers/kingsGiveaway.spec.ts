...
describe("KingsGiveawayAjaxHandler", () => {
    ...
    const knownVaultItems = [
        ...
        {type: 'prize_credit_stat_item', name: 'King\'s Credit', item_id: 420},
        {type: 'rainbow_scroll_case_convertible', name: 'Rainbow Scroll Case', item_id: 1974},
        {type: 'rainbow_luck_trinket', name: 'Rainbow Luck Charm', item_id: 1692},
    ];
